...
import {  otherWork, paintWork } from '../../data';
import HeaderDark from '../../components/Header/HeaderDark';
const OtherServices = () => {

const {products, description,name, price } = otherWork
return (<section>
  <HeaderDark />
  ...
  {}
    <div className='flex flex-col lg:flex-row items-center'>
      ...
      <div className='grid  flex-1 justify-center items-center mb-8 lg:mb-0'>
        <img className=' border rounded-md w-[600px] h-[400px] max-w-[900px] lg:max-w-sm' src={products[0].type} alt='' />
