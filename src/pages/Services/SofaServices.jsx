...
import {  sofaWork } from '../../data';
import HeaderDark from '../../components/Header/HeaderDark';
const SofaServices = () => {

const {products, description,name, price } = sofaWork
return (<section>
  <HeaderDark />
  ...
  {}
    <div className='flex flex-col lg:flex-row items-center'>
      ...
      <div className='grid  flex-1 justify-center items-center mb-8 lg:mb-0'>
        <img className='w-[600px] border rounded-md h-[400px] max-w-[900px] lg:max-w-sm' src={products[0].type} alt='' />
